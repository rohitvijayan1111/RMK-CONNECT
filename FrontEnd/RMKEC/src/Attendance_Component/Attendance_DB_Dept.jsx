...
export function Attendance_DB_Dept() {
  ...
  useEffect(() => {
    async function getData() {
      try {
        const response = await axios.post("http://localhost:3000/attendance/attendance-summary", { department: department});
        console.log('Attendance summary data:', response.data);
        setData(response.data);

        const response2 = await axios.post("http://localhost:3000/attendance/attendance-count-summary", { department: department, user: selectedYearGroup });
        console.log('Attendance count summary data:', response2.data);
        setCountData(response2.data);

        const response3 = await axios.post("http://localhost:3000/attendance/attendance-graph", { department: department, user: selectedYearGroup });
