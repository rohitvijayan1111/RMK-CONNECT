...
router.post('/send', function _callee2(req, res) {
  var _req$body2, subject, to, desc, mailOptions;

  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _req$body2 = req.body, subject = _req$body2.subject, to = _req$body2.to, desc = _req$body2.desc;
          console.log(req.body);
          mailOptions = {
            from: {
              name: 'RMKEC UPDATES',
        ...
        case 9:
          ...
          res.status(500).send('Error creating form or sending email: ' + _context2.t0);
...
router.post('/notifyHOD', function _callee3(req, res) {
...
router.post('/approveEventByHOD', function _callee4(req, res) {
...
router.post('/approveEventByAcademicCoordinator', function _callee5(req, res) {
...
router.post('/approveEventByPrincipal', function _callee6(req, res) {
...
router.post('/cancelEventByEventCoordinator', function _callee7(req, res) {
...
router.post('/cancelEventByHOD', function _callee8(req, res) {
...
router.post('/cancelEventByAcademicCoordinator', function _callee9(req, res) {
...
router.post('/cancelEventByPrincipal', function _callee10(req, res) {
  var _req$body10, formSubject, department, emails, emailList, mailOptions;

  return regeneratorRuntime.async(function _callee10$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          _req$body10 = req.body, formSubject = _req$body10.formSubject, department = _req$body10.department, emails = _req$body10.emails;
          emailList = Array.isArray(emails) ? emails : [emails];
          emailList.push(hodEmailMapping[department]);
          mailOptions = {
            from: {
        ...
        case 10:
          ...
          res.status(500).send('Error sending notification email: ' + _context10.t0);
